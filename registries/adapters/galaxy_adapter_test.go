...
func TestGalaxyRegistryName(t *testing.T) {
	ga := GalaxyAdapter{}
	assert.Equal(t, ga.RegistryName(), "galaxy", "galaxyadapter name does not match galaxy")
}

func TestGalaxyGetImageNames(t *testing.T) {
	testCases := []struct {
		name        string
		c           Configuration
		expected    []string
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			tc.c.URL = getGalaxyURL(t, serv)

			// create the adapter we want to test
			ga := GalaxyAdapter{Config: tc.c}

			// test the GetImageNames method
			output, err := ga.GetImageNames()
...
func TestGalaxyFetchSpecs(t *testing.T) {
	testCases := []struct {
		name        string
		c           Configuration
		input       []string
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			output, err := ga.FetchSpecs(tc.input)
...
func getGalaxyURL(t *testing.T, s *httptest.Server) *url.URL {
